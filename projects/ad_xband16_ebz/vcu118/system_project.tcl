...
#
#    e.g.
#    ID=42   make JESD_MODE=64B66B RX_LANE_RATE=13.2 TX_LANE_RATE=13.2 RX_JESD_M=8 TX_JESD_M=8 RX_JESD_L=4 TX_JESD_L=4 RX_JESD_S=1 TX_JESD_S=1 RX_JESD_NP=16 TX_JESD_NP=16 RX_NUM_LINKS=4 TX_NUM_LINKS=4
#    ID=43   make JESD_MODE=64B66B RX_LANE_RATE=26.4 TX_LANE_RATE=26.4 RX_JESD_M=8 TX_JESD_M=8 RX_JESD_L=4 TX_JESD_L=4 RX_JESD_S=1 TX_JESD_S=1 RX_JESD_NP=16 TX_JESD_NP=16 RX_NUM_LINKS=4 TX_NUM_LINKS=4


#
# Parameter description:
#   MCS_MODE : Used for multiple boards synchronizations
#      MASTER - Builds the master design that will generate the reference triggers for sync
#      SLAVE  - Builds the slave design that will receive the trigger
...
#   [RX/TX]_NUM_LINKS : Number of links - This project has 4 Apollos so 4 is the defaul value
...
set MCS_MODE [get_env_param MCS_MODE MASTER]
...
generate_target {instantiation_template} [get_files ./ad_xband16_ebz_vcu118.srcs/sources_1/ip/high_speed_selectio_wiz_1/high_speed_selectio_wiz_1.xci]
