...
source ../../ad_xband16_ebz/common/ad_xband16_ebz_bd.tcl
...
#Adding AXI Quad SPI IP with Startup
ad_ip_instance axi_quad_spi axi_quad_spi_0 [list \
  C_SPI_MEMORY {2} \
  C_USE_STARTUP {1} \
  C_USE_STARTUP_INT {1} \
  C_SPI_MODE {2} \
...
make_bd_intf_pins_external [get_bd_intf_pins axi_quad_spi_0/SPI_1]

#This AXI Address might need to change with different HDL designs
ad_cpu_interconnect 0x44BA0000 axi_quad_spi_0 

#The important parameter is mb-6 (microblaze interrupt 6) which also might need to change between HDL projects
ad_cpu_interrupt ps-16 mb-6 axi_quad_spi_0/ip2intc_irpt

#This Clock source might change with different designs.
ad_connect  sys_cpu_clk axi_quad_spi_0/ext_spi_clk
