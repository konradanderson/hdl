...
create_bd_port -dir O adf4030_trig_request_out

ad_ip_instance axi_adf4030 axi_adf4030_0
ad_ip_parameter axi_adf4030_0 CONFIG.CHANNEL_COUNT 5
ad_ip_parameter axi_adf4030_0 CONFIG.TRIGGER_STRETCH [expr {$MCS_MODE == "MASTER" ? 1 : 0}]
...
ad_connect axi_adf4030_0/trig_request_out adf4030_trig_request_out
...
if {!$HSCI_BYPASS} {
  ...
  ad_ip_instance  ilvector_logic hsci_pll_reset_logic_0
  ...
  ad_ip_instance  ilvector_logic hsci_pll_reset_logic_1
...
ad_ip_parameter tx_apollo_tpl_core/dac_tpl_core CONFIG.PNGEN_ENABLE 0
ad_ip_parameter tx_apollo_tpl_core/dac_tpl_core CONFIG.DUAL_DDS_DISABLE 1
...
ad_ip_parameter util_apollo_upack CONFIG.PIPELINE_STAGES 2
